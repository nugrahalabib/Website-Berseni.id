...
export default function FloatingWhatsApp() {
  ...
  return (
    ...
    // sehingga tanpa landmark ia jadi konten "yatim" bagi pengguna screen reader
    // (axe: region — Some page content is not contained by landmarks).
    <aside aria-label={getTranslation('waFloatAria')}>
      <a
        href={waUrl}
