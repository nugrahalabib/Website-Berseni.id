      ...
      <main id="main-content" className={styles.storeMain} style={{ ...textVars(dbContent || content || initialContent, 'text_classes_main'), backgroundColor: dbContent?.bg_classes_main || content?.bg_classes_main || '' }}>
        ...
        <section className={styles.heroSection}>
          <div className={styles.heroInner}>
            <span className={styles.heroSubtitle} style={{ color: txt('text_classes_header_body') }}>Berseni Academy & Hub</span>
            <h1 className={styles.heroTitle} style={{ color: txt('text_classes_header_title') }}>
              {getTranslation('classesTitle')}
            </h1>
            <p className={styles.heroDesc} style={{ color: txt('text_classes_header_body') }}>
          ...
          <div className={styles.gridInner}>
            {filteredProducts.length > 0 ? (
              ...
              <div className={styles.emptyStore}>
                ...
                <p><RichText text={getTranslation('emptyClassesDesc')} inline /></p>
                <button 
