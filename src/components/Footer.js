        ...
        <div className={styles.footerGrid}>
          ...
          <div className={styles.footerCol}>
            ...
            <div className={styles.socials}>
              ...
              >
                <CustomIcon src={dbContent?.footerIconWa} size={20}>
              ...
              >
                <CustomIcon src={dbContent?.footerIconIg} size={20}>
                  <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
              ...
              >
                <CustomIcon src={dbContent?.footerIconTiktok} size={20}>
                  <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
              ...
              >
                <CustomIcon src={dbContent?.footerIconYoutube} size={20}>
                  <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Facebook (tampil hanya bila diisi admin) */}
              {dbContent?.footerLinkFacebook && (
                <a
                  href={dbContent.footerLinkFacebook}
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Facebook"
                  className={`${styles.socialIcon} ${styles.facebook}`}
                >
                  <CustomIcon src={dbContent?.footerIconFacebook} size={20}>
                    <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Email (tampil hanya bila diisi admin) */}
              {dbContent?.footerLinkEmail && (
                <a
                  href={`mailto:${dbContent.footerLinkEmail}`}
                  aria-label="Email"
                  className={`${styles.socialIcon} ${styles.email}`}
                >
                  <CustomIcon src={dbContent?.footerIconEmail} size={20}>
                    <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M24 4.5v15c0 .85-.65 1.5-1.5 1.5H1.5C.65 21 0 20.35 0 19.5v-15C0 3.65.65 3 1.5 3h21c.85 0 1.5.65 1.5 1.5zM22 6.99l-9.4 6.63c-.36.26-.84.26-1.2 0L2 6.99V19h20V6.99zM2 5l10 7 10-7H2z" />
                    </svg>
                  </CustomIcon>
                </a>
              )}
